...
//
// 到上一章为止，每一轮都是人开的口：你打一行字，模型跑一轮，停下来等你。
// 这一章给模型一把闹钟——schedule_wakeup 工具让它自己说"多久之后再叫我，
// 叫醒我的时候对我说这句话"。到点了，进程自己开一轮，不用你在场。
//
// Part 7 的头两章都在搭骨架（常驻循环、插话），加的东西模型一个都看不见；
// 从这一章起又变回全书的老路子：加一个工具。而且这个工具能成立，全靠前两
// 章铺好的东西——ctx 把闹钟递到工具手里（练习 24 铺的），收件箱让到点的
// 那一拍能塞进正在跑的轮次（练习 25 建的）。
package main
